    ...
    public class AbstractMain {
        public static void main(String[] args) {
            ...
            whale2.swimming();
            // castingWhaleToMammal = swimmgin(); // 자식 클래스가 가진 멤버에는 접근이 불가
            whale2.breath();
            castingWhaleToMammal.breath();

            //다운 캐스팅 : 업캐스팅한 인스턴트를 다시 본인의 데어터 타입으로 캐스팅 하는 것
            Whale downCastingWhale = (Whale)castingWhaleToMammal;
            downCastingWhale.swimming();

            Mammal[] arrMammal = new Mammal[3];
            arrMammal[0] = new Whale("고래1");
            arrMammal[1] = new Whale("고래2");
            arrMammal[2] = new FlyingSquirrel("날다람쥐");
